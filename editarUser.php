...
<head>
    ...
    <title>Overdrive - Editar Usuário</title>
</head>
                ...
                <div class="column_left">
                    <p>
                        ...
                        <input type="text" name="nome" id="id_nome" maxlength="255" placeholder="Digite o Nome"
                            value="<?= $dados[0]['nome'] ?>" required>
                    </p>
                    <p>
                        <label for="id_cpf">CPF</label>
                        <input type="text" data-mask="000.000.000-00" name="cpf" id="id_cpf" minlength="14"
                            maxlength="14" placeholder="Digite o CPF" value="<?= $dados[0]['cpf'] ?>"
                            oninput="validacoesCpf()" required>
                        <small id="cpfTeste"></small>
                    </p>
                    <p>
                        <label for="id_cnh">CNH</label>
                        <input type="text" name="cnh" id="id_cnh" minlength="9" maxlength="10"
                            placeholder="Digite a CNH" value="<?= $dados[0]['cnh'] ?>" required>
                    </p>
                    <p id="p_telefone">
