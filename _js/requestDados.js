  ...
  if(json.error){
    ...
    if(json.usuarios !== -1){
      ...
      json.usuarios.map(function(usuario){
        ...
        if(json.sessao === 'A') {
          tag = `<p class="center" style="margin-top: .7em;"><i class="fi fi-rr-trash icons_cards center icon_trash user_trash"></i><a href="editar.php?tipo=usuario&id=${usuario.id}&edit=false" style="text-decoration: none;"><i class="fi fi-rr-edit icons_cards center icon_edit"></i></a></p>`
        }
    ...
    if(json.empresas !== -1){
      ...
      json.empresas.map(function(empresa){
        ...
        if(json.sessao === 'A') {
          tag = `<p class="center" style="margin-top: .7em;"><i class="fi fi-rr-trash icons_cards center icon_trash emp_trash"></i><a href="editar.php?tipo=empresa&id=${empresa.id}&edit=false" style="text-decoration: none;"><i class="fi fi-rr-edit icons_cards center icon_edit"></i></a></p>`
        }
