...
<html lang="pt-br">
  ...
  <body id="full_content_cadastro" class="center">
    <main class="col-10 center" style="justify-content: center; color: var(--red-dark);">
      <div id="cadastro_emp" class="cadastro col-12 col-md-8 center" style="border-radius: 40px; box-shadow: 10px 10px 20px #000; 
        <?php
            if($tipo === 'empresa') { 
                echo 'display: flex;';
            } else {
      ...
      <div id="cadastro_user" class="cadastro col-12 col-md-8 center" style="border-radius: 40px; box-shadow: 10px 10px 20px #000; 
        <?php
            if($tipo === 'usuario') { 
                echo 'display: flex;';
            } else {
