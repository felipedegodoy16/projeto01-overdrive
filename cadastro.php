...
<body id="full_content_cadastro" class="center" style="flex-direction: column;">
    <main id="main_cadastro" class="col-10 center">
        ...
        <div id="cadastro_emp" class="cadastro col-12 col-md-8 center transition_section <?= $empStyle ?>">
            ...
            <form class="form_cadastro" action="<?= $_SERVER['PHP_SELF'] . "?tipo=empresa" ?>" method="post"
                enctype="multipart/form-data">
                <div class="column_left">
                    <p>
                        <label for="id_cnpj_emp">CNPJ</label>
                        <input type="text" name="cnpj_emp" id="id_cnpj_emp" minlength="18" maxlength="18"
                            placeholder="Digite o CNPJ" value="<?= $cnpjEmp ?>" required>
                    ...
                    <p>
                        ...
                        <input type="text" name="nome_emp" id="id_nome_emp" maxlength="255"
                            placeholder="Digite a Razão Social" value="<?= $nomeEmp ?>" required>
                    </p>
                    <p>
                        <label for="id_fantasia_emp">Fantasia</label>
                        <input type="text" name="fantasia_emp" id="id_fantasia_emp" maxlength="255"
                            placeholder="Digite o Nome Fantasia" value="<?= $fantasiaEmp ?>" required>
                    </p>
                    <p id="p_telefone_emp">
                        <label for="id_telefone_emp">Telefone</label>
                        <input type="text" name="telefone_emp" id="id_telefone_emp" minlength="10" maxlength="15"
                            placeholder="Digite o Telefone" value="<?= $telefoneEmp ?>" onfocus="tirarFormat(this)"
                            oninput="removeChar(this)" required>
                    </p>
                    <p>
                        <label for="id_responsavel_emp">Reponsável</label>
                        <input type="text" name="responsavel_emp" id="id_responsavel_emp" maxlength="255"
                            placeholder="Digite o Responsável" value="<?= $responsavelEmp ?>" required>
                    </p>
                    <p>
                ...
                <div class="address_data">
                    <p>
                        ...
                        <input type="text" data-mask="00000-000" name="cep_emp" id="id_cep_emp" minlength="9"
                            maxlength="9" placeholder="Digite o CEP" value="<?= $cepEmp ?>" required>
                        <small id="cepTesteEmp"></small>
                    </p>
                    <p>
                        <label for="id_rua_emp">Rua</label>
                        <input type="text" name="rua_emp" id="id_rua_emp" maxlength="255" placeholder="Digite a Rua"
                            value="<?= $ruaEmp ?>" required>
                    </p>
                    <p>
                        <label for="id_bairro_emp">Bairro</label>
                        <input type="text" name="bairro_emp" id="id_bairro_emp" maxlength="255"
                            placeholder="Digite o Bairro" value="<?= $bairroEmp ?>" required>
                    </p>
                    <p>
                        <label for="id_numero_emp">Numero</label>
                        <input type="text" name="numero_emp" id="id_numero_emp" maxlength="6"
                            placeholder="Digite o Número" value="<?= $numeroEmp ?>" required>
                    </p>
                    <p>
                        <label for="id_cidade_emp">Cidade</label>
                        <input type="text" name="cidade_emp" id="id_cidade_emp" maxlength="255"
                            placeholder="Digite a Cidade" value="<?= $cidadeEmp ?>" required>
                    </p>
                    <p>
                        <label for="id_estado_emp">Estado (UF)</label>
                        <input type="text" name="estado_emp" id="id_estado_emp" minlength="2" maxlength="2"
                            placeholder="Exemplo: SP, RJ..." value="<?= $estadoEmp ?>" required>
                    </p>
                </div>
                <p class="center p_btn_cadastrar" style="flex-direction: row;">
                    <button onclick="changeForm()" class="btn_habilitado" style="text-transform: uppercase;">Trocar
                        Formulário</button>
        ...
        <div id="cadastro_user" class="cadastro col-12 col-md-8 center transition_section <?= $userStyle ?>">
            ...
            <form class="form_cadastro" action="<?= $_SERVER['PHP_SELF'] . "?tipo=usuario" ?>" method="post"
                enctype="multipart/form-data">
                <div class="column_left">
                    <p>
                        <label for="id_nome">Nome</label>
                        <input type="text" name="nome" id="id_nome" maxlength="255" placeholder="Digite o Nome"
                            value="<?= $nome ?>" required>
                    </p>
                    <p>
                        <label for="id_cpf">CPF</label>
                        <input type="text" data-mask="000.000.000-00" name="cpf" id="id_cpf" minlength="14"
                            maxlength="14" placeholder="Digite o CPF" value="<?= $cpf ?>" required>
                        <small id="cpfTeste"></small>
                    </p>
                    <p>
                        <label for="id_cnh">CNH</label>
                        <input type="text" data-mask="000000000" name="cnh" id="id_cnh" minlength="9" maxlength="9"
                            placeholder="Digite a CNH" value="<?= $cnh ?>" required>
                    </p>
                    <p id="p_telefone">
                    ...
                    <p>
                        ...
                        <input type="text" name="carro" id="id_carro" maxlength="255" placeholder="Digite o Carro"
                            value="<?= $carro ?>" required>
                    </p>
                    <p>
                    ...
                    <p style="position: relative;">
                        ...
                        <input type="password" name="password" id="id_password" placeholder="DIGITE A SENHA"
                            minlength="8" maxlength="255" required style="text-transform: none;">
                    ...
                    <div id="passwordTips" style="display: none;">
                        <ul>
                            ...
                            <li class="tip"><i class="fi fi-rr-x icon-tip center"></i> Letras Maiúsculas e Minúsculas
                            </li>
                    ...
                    <p style="position: relative;">
                        ...
                        <input type="password" name="password_confirm" id="id_password_confirm"
                            placeholder="CONFIRME A SENHA" minlength="8" maxlength="255" required style="text-transform: none;">
                ...
                <div class="address_data">
                    <p>
                        ...
                        <input type="text" data-mask="00000-000" name="cep" id="id_cep" minlength="9" maxlength="9"
                            placeholder="Digite o CEP" value="<?= $cep ?>" required>
                    ...
                    <p>
                        ...
                        <input type="text" name="numero" id="id_numero" maxlength="6" placeholder="Digite o Número"
                    ...
                    <p>
                        ...
                        <input type="text" name="estado" id="id_estado" minlength="2" maxlength="2"
                            placeholder="Exemplo: SP, RJ..." value="<?= $estado ?>" required>
                    </p>
                    <p>
